...
var MIN_TIME = Object(util["v" /* parseDate */])('00:00:00', 'HH:mm:ss');
var MAX_TIME = Object(util["v" /* parseDate */])('23:59:59', 'HH:mm:ss');

var time_rangevue_type_script_lang_js_minTimeOfDay = function minTimeOfDay(date) {
  return Object(util["p" /* modifyDate */])(MIN_TIME, date.getFullYear(), date.getMonth(), date.getDate());
};

var time_rangevue_type_script_lang_js_maxTimeOfDay = function maxTimeOfDay(date) {
  return Object(util["p" /* modifyDate */])(MAX_TIME, date.getFullYear(), date.getMonth(), date.getDate());
};
...
/* harmony default export */ var time_rangevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleConfirm: function handleConfirm() {
      ...
      this.minDate = Object(util["o" /* limitTimeRange */])(this.minDate, minSelectableRange, this.format);
      this.maxDate = Object(util["o" /* limitTimeRange */])(this.maxDate, maxSelectableRange, this.format);
    ...
    isValidValue: function isValidValue(date) {
      return Array.isArray(date) && Object(util["z" /* timeWithinRange */])(this.minDate, this.$refs.minSpinner.selectableRange) && Object(util["z" /* timeWithinRange */])(this.maxDate, this.$refs.maxSpinner.selectableRange);
    },
    handleKeydown: function handleKeydown(event) {
      var keyCode = event.keyCode;
      var mapping = { 38: -1, 40: 1, 37: -1, 39: 1 };
